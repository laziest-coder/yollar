...
class Report(models.Model):
    ...
    region_uz = models.CharField(max_length=255)
    region_ru = models.CharField(max_length=255)
    district_uz = models.CharField(max_length=255)
    district_ru = models.CharField(max_length=255)
    street_uz = models.CharField(max_length=255)
    street_ru = models.CharField(max_length=255)
